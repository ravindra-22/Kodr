...
const Page1 = () => {
  return (
    // main div
    <div className="py-8 w-11/12 mx-auto flex items-center justify-between">
      {/*left div  */}
      <div className=" flex flex-col">
        {/* headings */}
        <h1 className="text-8xl">Turning heads</h1>
        <h1 className="text-8xl">and conquering</h1>
        <div className="flex gap-8">
          <h1 className="text-8xl">hearts</h1>
          {/* heading logo */}
          <div className="h-20 w-16 pt-8 ">
            <svg
              class="stroke-2"
      ...
      {/* right div */}
      <div className="flex flex-col place-self-end w-1/4 gap-8">
        <p>
          NiceAtNoon is een boutique design studio gespecialiseerd in branding
          en webdesign.
        </p>
        <button className="text-left h-14 mr-40 px-2 border-2 border-black rounded-2xl bg-white">
          Bekijk Projecten
        </button>
      </div>
    </div>
